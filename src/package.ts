...
export var description = "Google Maps, but easier.";
...
export var repository = { "type": "git", "url": "git+https://github.com/shumatsumonobu/google-map-extension.git" };
export var files = ["dist/*.js", "types/*.d.ts", "package.json", "README.md", "CHANGELOG.md", "examples", "screenshots"];
...
export var author = "shumatsumonobu <shumatsumonobu@gmail.com> (https://x.com/shumatsumonobu)";
export var license = "MIT";
export var bugs = { "url": "https://github.com/shumatsumonobu/google-map-extension/issues", "email": "shumatsumonobu@gmail.com" };
export var homepage = "https://github.com/shumatsumonobu/google-map-extension#readme";
